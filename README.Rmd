...
library(knitr)
knit_hooks$set(optipng = hook_optipng, pngquant = hook_pngquant)
opts_chunk$set(fig.path = "man/figures/",
               fig.width = 6, fig.height = 6, dpi = 72,
               fig.retina = 1, optipng = '-o7', pngquant = '--speed=1')
```
...
[![Coverage Status](https://coveralls.io/repos/github/jhollist/quickmapr/badge.svg?branch=master)](https://coveralls.io/github/jhollist/quickmapr?branch=master)
